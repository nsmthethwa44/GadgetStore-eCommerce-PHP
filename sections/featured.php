        ...
        <div class="content">
            <div class="box">
                <div class="special-box">
                    <h3>Special Offer</h3>
                    <img src="./assets/img/special.png" alt="" class="img-box">
            ...
            <div class="box">
                <div class="title-filter">
                 ...
                 <ul class="list list-filter">
                        <li class="active" data-filter="all"><span></span>All Products</li>
                        <li data-filter="laptop"><span></span>Laptop</li>
                        <li data-filter="keyboard"><span></span>Keyboard</li>
                        <li data-filter="gaming mouse"><span></span>Gaming Mouse</li>
                        <li data-filter="headphones"><span></span>Headphones</li>
                    </ul>
                </div>
                ...
                <div class="wrapper">
                    ...
                    while($data = mysqli_fetch_array($results)){
                        ?>
                            <div class="container-box items-container" data-category="<?php echo strtolower($data['category']); ?>">
                               <div class="card">
                                 <div class="box-img">
